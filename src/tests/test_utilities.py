...
class TestUtilities(unittest.TestCase):
    ...
    def test_chat_completion_uses_standard_openai_responses_api_when_sk_key_is_present(self):
        ...
        ), mock.patch("utilities.MODEL_NAME", "gpt-4o"):
        ...
        self.assertEqual(create_kwargs["model"], "gpt-4o")
    ...
    def test_chat_completion_falls_back_when_requested_model_does_not_exist(self):
        ...
        response_api.create.side_effect = [
            RuntimeError("Error code: 400 - {'error': {'message': \"The requested model 'gpt-4o' does not exist.\", 'code': 'model_not_found'}}"),
        ...
        self.assertEqual(response_api.create.call_args_list[0].kwargs["model"], "gpt-4o")
        self.assertEqual(response_api.create.call_args_list[1].kwargs["model"], "gpt-4o")
